...
public:
    ...
    void setupUi(QWidget *numericPad)
    {
        if (numericPad->objectName().isEmpty())
            numericPad->setObjectName(QString::fromUtf8("numericPad"));
        numericPad->resize(306, 446);
        numericPad->setStyleSheet(QString::fromUtf8("background-image:url(:/transparent.png);"));
        calcForm = new QFrame(numericPad);
        calcForm->setObjectName(QString::fromUtf8("calcForm"));
        calcForm->setGeometry(QRect(0, 0, 306, 446));
...
""));
    ...
    void retranslateUi(QWidget *numericPad)
    {
        numericPad->setWindowTitle(QApplication::translate("numericPad", "Form", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
