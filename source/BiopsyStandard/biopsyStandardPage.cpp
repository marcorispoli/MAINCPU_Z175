#define BIOPSY_STANDARD_PAGE_C
#include "../application.h"
#include "../appinclude.h"
#include "../globvar.h"

#define _BACKGROUND_Y_BIOPSY  "://BiopsyStandard/BiopsyStandard/background_biopsy_Y.png"
#define _BACKGROUND_C_BIOPSY  "://BiopsyStandard/BiopsyStandard/background_biopsy_C.png"

#define _PUSH_UP_C_PIX "://BiopsyStandard/BiopsyStandard/biopsy_manual_up_C.png"
#define _PUSH_DWN_C_PIX "://BiopsyStandard/BiopsyStandard/biopsy_manual_dwn_C.png"
#define _PUSH_UP_Y_PIX "://BiopsyStandard/BiopsyStandard/biopsy_manual_up_Y.png"
#define _PUSH_DWN_Y_PIX "://BiopsyStandard/BiopsyStandard/biopsy_manual_dwn_Y.png"
...
BiopsyStandardPage::BiopsyStandardPage(bool local, QString bgl, QString bgs , bool showLogo, int w,int h, qreal angolo,QPainterPath pn, int pgpn, QPainterPath pp, int pgpp, int pg) : GWindow(bgl,showLogo,w,h, angolo,pn,pgpn,pp,pgpp,pg)
{
    QFont font;
    ...
    lineaMarginePix = addPixmap(QPixmap("://BiopsyStandard/BiopsyStandard/linea_margine.png"));
    ...
    buttonsPix = addPixmap(QPixmap("://BiopsyStandard/BiopsyStandard/buttonsYnoHome.png"));
    ...
    pulsanteImgOn = new GPush((GWindow*) this, QPixmap("://BiopsyStandard/BiopsyStandard/imageIcon.png"),QPixmap("://BiopsyStandard/BiopsyStandard/imageIcon.png"),setPointPath(8,700,3,800,3,800,100,700,100),700,3,0,0);
    ...
    #define BIOPSY_HOLDER_PIX  "://BiopsyStandard/BiopsyStandard/biopsy_holder.png"
    #define BIOPSY_ALR_HOLDER_POS   373,103
    #define BIOPSY_ALR_HOLDER_PIX  "://BiopsyStandard/BiopsyStandard/allarme_holder.png"
    ...
    #define BIOPSY_DEMO_PIX  "://BiopsyStandard/BiopsyStandard/biopsy_demo.png"
    demoPix = addPixmap(QPixmap(BIOPSY_DEMO_PIX));
    demoPix->setPos(BIOPSY_DEMO_POS);

    calibPix = addPixmap(QPixmap("://BiopsyStandard/BiopsyStandard/calib_pix.png"));
    calibPix->setPos(730,4);

    rotPix = addPixmap(QPixmap("://BiopsyStandard/BiopsyStandard/rotPixY.png"));
    rotPix->setPos(225,76);

    #define BIOPSY_XRAY_POS   0,0
    #define BIOPSY_XRAY_PIX  "://BiopsyStandard/BiopsyStandard/biopsy_xray.png"
...
BiopsyStandardPage::~BiopsyStandardPage()
{
   // this->killTimer(timerWDG);
}

void BiopsyStandardPage::setOpenStudy(void){
...
void BiopsyStandardPage::setCloseStudy(void){
    // Sgancia il database
 ...
 *
 */
void BiopsyStandardPage::InitBiopsyPage(void)
{    

    // Discrimina fra modalit� frustoli e standard
    ...
    if(specimenMode){
        if(angolo > 0){
            setBackground("://BiopsyStandard/BiopsyStandard/specimen_r.png");
            specimenLeft = false;
        }  else if(angolo <= 0){
            setBackground("://BiopsyStandard/BiopsyStandard/specimen_l.png");
            specimenLeft = true;
        }
        ...
        if (localStudy==false)
        {
            ...
            buttonsPix->setPixmap(QPixmap("://BiopsyStandard/BiopsyStandard/buttonsCnoHome.png"));
            rotPix->setPixmap(QPixmap("://BiopsyStandard/BiopsyStandard/rotPixC.png"));
        ...
        else
        {
            ...
            buttonsPix->setPixmap(QPixmap("://BiopsyStandard/BiopsyStandard/buttonsYnoHome.png"));
            rotPix->setPixmap(QPixmap("://BiopsyStandard/BiopsyStandard/rotPixY.png"));
        }
...
void BiopsyStandardPage::childStatusPage(bool stat,int opt)
{
    if(stat==false){
...
void BiopsyStandardPage::timerEvent(QTimerEvent* ev)
{
...
void BiopsyStandardPage::mousePressEvent(QGraphicsSceneMouseEvent* event)
{
...
void BiopsyStandardPage::setIntestazione()
{
...
void BiopsyStandardPage::setArmAngolo(void)
{
    QString str;
...
void BiopsyStandardPage::setTrxAngolo(void)
{
    QString str;
...
void BiopsyStandardPage::setBiopXYZ(void)
{

    int X,Y,Z;
    X = ApplicationDatabase.getDataI(_DB_BIOP_X);
    Y = ApplicationDatabase.getDataI(_DB_BIOP_Y);
    Z = ApplicationDatabase.getDataI(_DB_BIOP_Z);


    QString x,y,z;

    if(X<0) x = "ND";
    else x = QString("%1").arg((int) X);
    if(Y<0) y = "ND";
    else y = QString("%1").arg((int) Y);
    if(Z<0) z = "ND";
    else z = QString("%1").arg((int) Z);
 ...
 */
void BiopsyStandardPage::setCompressione(void)
{
...
void BiopsyStandardPage::setSpessore(void)
{
...
void BiopsyStandardPage::valueChanged(int index,int opt)
{
...
void BiopsyStandardPage::buttonActivationNotify(int id, bool status,int opt)
{
...
void BiopsyStandardPage::languageChanged()
{
    setIntestazione();
}
...
void BiopsyStandardPage::updateHolder(void){
...
void BiopsyStandardPage::updateManualActivation(void){
    if(specimenMode){
