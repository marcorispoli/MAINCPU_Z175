#ifndef BIOPSY_STANDARD_DEVICE_H
#define BIOPSY_STANDARD_DEVICE_H

#include "../application.h"


class biopsyStandardDevice : public QObject
{
    Q_OBJECT
public:
    explicit biopsyStandardDevice(QObject *parent = 0);
...
#endif // BIOPSY_STANDARD_DEVICE_H
