...
#define _DB_XDUDOSE                      _DB_SERVICE26_INT
#define _DB_XDMAS                        _DB_SERVICE27_INT
#define _DB_ANOPER_STOP_ATTESA_DATI      _DB_SERVICE28_INT



#define PANNELLO_PROIEZIONI             1
#define PANNELLO_COMANDI                4
#define PANNELLO_KV                     6
#define PANNELLO_MAS                    7
#define PANNELLO_OPZIONI                8
