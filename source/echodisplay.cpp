...
void EchoDisplay::rxData(QByteArray data)
{
    ...
    case _ECHO_PG:
        stream >> ival;
        stream >> iival;
        GWindow::setPage(ival,iival,DBase::_DB_NO_ECHO); // Cambia pagina disabilitando il contro-echo
        break;
    ...
    case _ECHO_DB_ITEM:
        ...
        case DBase::_DB_T_UC:
            ...
            break;
        default:
            PRINT("DB campo non riconosciuto");
            return;
        }
        break;
    ...
    default:
        PRINT("PACCHETTO NON RICONOSCIUTO");
        return;
    }
