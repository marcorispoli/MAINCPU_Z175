...
#define ANALOG_FILTRO_AUTO   0          // Filtro automatico in funzione di PLOG
#define ANALOG_FILTRO_FISSO  1          // Filtro in modalit‡ fissa
...
#define _MAX_CGS_MM 150
#define _D_CGS_MM   5

#define _MIN_CGS_DKV 200
#define _MAX_CGS_DKV 400
#define _D_CGS_DKV   5
...
typedef struct {
    ...
    float cg[1 + _LEN_CGS_KV][1 + _LEN_CGS_MM];
    bool cg_configured;
...
typedef struct{
    QString filename;                       // Serve per il salvataggio successivo
...
typedef struct{
    QList<profileCnf_Str> profileList;
}analogProfileCnf_Str;
