...
COPY_IF_NOT_EXIST collimazione.cnf ./CONFIG/ $ROOT/resource/config/
COPY_IF_NOT_EXIST tomoCfg_1F.cnf ./CONFIG/ $ROOT/resource/config/
COPY_IF_NOT_EXIST tomoCfg_2F.cnf ./CONFIG/ $ROOT/resource/config/
COPY_IF_NOT_EXIST tomoCfg_3F.cnf ./CONFIG/ $ROOT/resource/config/
COPY_IF_NOT_EXIST tomoCfg_4F.cnf ./CONFIG/ $ROOT/resource/config/
COPY_IF_NOT_EXIST tomoCfg_5F.cnf ./CONFIG/ $ROOT/resource/config/
