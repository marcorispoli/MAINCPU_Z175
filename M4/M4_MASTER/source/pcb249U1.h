...
#undef extrd
  ...
  // Aggiunto indirizzi per nuova collimazione dinamica con EW
...
volatile _DeviceRegItem_Str  PCB249U1_Registers[]=
  ...
  //                    DEFINIZIONE DI BITFIELD NEL TARGET
  //////////////////////////////////////////////////////////////////////////////  
  #define PCB249U1_EW_MODE        _REGID(RG249U1_SYS_FLAGS0),0,PCB249U1_Registers // Modo dinamico con EW se 1, Gonio se 0
  ...
  #define PCB249U1_TUBE_TEMP      _REGID(RG249U1_SYS_FLAGS0),7,PCB249U1_Registers
  ...
  ext bool pcb249U1_initTomoColli(_RxStdSeq_Str* pParam);
