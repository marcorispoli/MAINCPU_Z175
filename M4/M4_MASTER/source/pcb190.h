...
#undef extrd
 ...
 #define _pSAMPLE_TIME 0x90     // BANCO 2/3
  ...
  #define RG190_I_ANODICA         14,23+_MAP_0 ,_BNK01,_8BIT ,_RD, _VL, (unsigned short)0  // Lettura corrente anodica
  #define RG190_HV                15,25+_MAP_0 ,_BNK01,_8BIT ,_RD, _VL, (unsigned short)0  // Lettura HV
  #define RG190_IFIL              16,26+_MAP_0 ,_BNK01,_8BIT ,_RD, _VL, (unsigned short)0  // Lettura I FIL
  #define RG190_VFIL              17,27+_MAP_0 ,_BNK01,_8BIT ,_RD, _VL, (unsigned short)0  // Lettura V FIL
  #define RG190_FUOCO             18,31+_MAP_0 ,_BNK01,_8BIT ,_RD, _NVL, (unsigned short)0 // Selezione corrente del fuoco
  #define RG190_GRID              19,32+_MAP_0 ,_BNK01,_8BIT ,_RD, _NVL, (unsigned short)0 // Selezione corrente Griglia        
  
  #define PR190_IWARM             20, 8+_pPAR ,_BNK01,_16BIT,_RW, _NVL, (unsigned short)0  // Corrente di riscaldamento filamento
  #define PR190_STARTER           21,10+_pPAR ,_BNK01,_8BIT ,_RW, _NVL, (unsigned short)0  // 0 = INTERNO, 1 = STARTER IAE

  #define REG190_RX_TIME          22,0+_pSAMPLE ,_BNK23,_16BIT ,_RD, _VL, (unsigned short)0  // Indice campioni BUFFER 0 I ANODICA
  #define REG190_RX_TIME_PRE      23,2+_pSAMPLE ,_BNK23,_16BIT ,_RD, _VL, (unsigned short)0  // Indice campioni BUFFER 0 I ANODICA
  #define REG190_RX_TIME_PLS      24,4+_pSAMPLE ,_BNK23,_16BIT ,_RD, _VL, (unsigned short)0  // Indice campioni BUFFER 0 I ANODICA

  #define PR190_N_SAMPLE_AEC      25,6+_pSAMPLE ,_BNK23,_8BIT ,_RD, _NVL, (unsigned short)0  // Indice campioni BUFFER 0 I ANODICA
  #define PR190_N_SAMPLE_I        26,7+_pSAMPLE ,_BNK23,_8BIT ,_RD, _NVL, (unsigned short)0  // Indice campioni BUFFER 0 I ANODICA
  #define PR190_N_SAMPLE_V        27,8+_pSAMPLE ,_BNK23,_8BIT ,_RD, _NVL, (unsigned short)0  // Indice campioni BUFFER 1 HV
  #define PR190_SAMPLES_I         28,9+_pSAMPLE ,_BNK23,_8BIT ,_RD, _NVL, (unsigned short)0  // Indice campioni BUFFER 0 I ANODICA
  #define PR190_SAMPLES_V         29,PCB190_NSAMPLES+9+_pSAMPLE ,_BNK23,_8BIT ,_RD, _NVL, (unsigned short)0  // Indice campioni BUFFER 0 I ANODICA
  ...
  #define RG190_AEC               32,_MAP_0+4 ,_BNK01,_8BIT ,_RW, _VL, (unsigned short)0  // Configurazione

  // Nuovi indirizzi per diagnostica tensioni
  #define RG190_HV_RXEND          33,34+_MAP_0 ,_BNK01,_8BIT ,_RD, _NVL, (unsigned short)0 // HV campionata al termine raggi
  #define RG190_V_HV              34,36+_MAP_0 ,_BNK01,_8BIT ,_RD, _NVL, (unsigned short)0 // HV campionata in IDLE
  #define RG190_VAMPL_FIL         35,37+_MAP_0 ,_BNK01,_8BIT ,_RD, _NVL, (unsigned short)0 // V Temperatura amplificatore filamento
  #define RG190_MAS_TEST          36,01+_pMAS  ,_BNK23,_16BIT ,_RD, _NVL, (unsigned short)0 // Lettura MAS di test
  #define RG190_MAS_DATA          37,03+_pMAS  ,_BNK23,_16BIT ,_RD, _NVL, (unsigned short)0 // Lettura MAS rx

  // Diagnostica tensioni
  #define RG190_V_32              38,0+_pMainData ,_BNK23,_8BIT ,_RD, _NVL, (unsigned short)0
  #define RG190_V_M32             39,1+_pMainData ,_BNK23,_8BIT ,_RD, _NVL, (unsigned short)0
  #define RG190_V_15              40,2+_pMainData ,_BNK23,_8BIT ,_RD, _NVL, (unsigned short)0
  #define RG190_V_12              41,3+_pMainData ,_BNK23,_8BIT ,_RD, _NVL, (unsigned short)0
  #define RG190_V_M12             42,4+_pMainData ,_BNK23,_8BIT ,_RD, _NVL, (unsigned short)0
  #define RG190_V_15EXT           43,5+_pMainData ,_BNK23,_8BIT ,_RD, _NVL, (unsigned short)0

  #define RG_SAMPLED_IFIL         44,35+_MAP_0 ,_BNK01,_8BIT ,_RD, _NVL, (unsigned short)0
  #define RG16_IFIL_DAC           45,38+_MAP_0 ,_BNK01,_16BIT ,_RD, _NVL, (unsigned short)0

  #define PR16_MAX_IFIL           46, 0+_pPAR ,_BNK01,_16BIT ,_RW, _NVL, (unsigned short)0  // Configurazione Raggi
  #define PR_IFIL_LIMIT           47, 5+_pPAR ,_BNK01,_8BIT ,_RW, _NVL, (unsigned short)0  // Configurazione Raggi

  #define PR190_DELAY_DGN         48, 2+_pPAR ,_BNK01,_8BIT ,_RW, _VL, (unsigned short)0  // Configurazione Raggi

  // Registri di campinamento correnti Starter interno (Se configurato)
  #define RG190_AR_STAT           49,0+_pAR_DATA ,_BNK01,_8BIT ,_RD, _NVL, (unsigned short)0
  #define RG190_AR_MAIN_IRUN      50,8+_pAR_DATA ,_BNK01,_8BIT ,_RD, _NVL, (unsigned short)0
  #define RG190_AR_SHIFT_IRUN     51,9+_pAR_DATA ,_BNK01,_8BIT ,_RD, _NVL, (unsigned short)0
  #define RG190_AR_MAIN_IKEEP     52,10+_pAR_DATA ,_BNK01,_8BIT ,_RD, _NVL, (unsigned short)0
  #define RG190_AR_SHIFT_IKEEP    53,11+_pAR_DATA ,_BNK01,_8BIT ,_RD, _NVL, (unsigned short)0
  #define RG190_AR_MAIN_IOFF      54,12+_pAR_DATA ,_BNK01,_8BIT ,_RD, _NVL, (unsigned short)0
  #define RG190_AR_SHIFT_IOFF     55,13+_pAR_DATA ,_BNK01,_8BIT ,_RD, _NVL, (unsigned short)0

  // Contatori di lancio
  #define RG190_ARLS_COUNT        56,15+_pAR_DATA ,_BNK01,_8BIT ,_RW, _VL, (unsigned short)0
  #define RG190_ARHS_COUNT        57,28+_MAP_0 ,_BNK01,_8BIT ,_RW, _VL, (unsigned short)0


  // Parametri diagnostica starter
  #define PR_IMAIN_OFF_MAX        58,15+_pPAR ,_BNK01,_8BIT ,_RW, _NVL, (unsigned short)0
  #define PR_ISHIFT_OFF_MAX       59,16+_pPAR ,_BNK01,_8BIT ,_RW, _NVL, (unsigned short)0
  #define PR_IMAIN_RUN_MAX        60,17+_pPAR ,_BNK01,_8BIT ,_RW, _NVL, (unsigned short)0
  #define PR_ISHIFT_RUN_MAX       61,18+_pPAR ,_BNK01,_8BIT ,_RW, _NVL, (unsigned short)0
  #define PR_IMAIN_KEEP_MAX       62,19+_pPAR ,_BNK01,_8BIT ,_RW, _NVL, (unsigned short)0
  #define PR_ISHIFT_KEEP_MAX      63,20+_pPAR ,_BNK01,_8BIT ,_RW, _NVL, (unsigned short)0
  #define PR_IMAIN_RUN_MIN        64,21+_pPAR ,_BNK01,_8BIT ,_RW, _NVL, (unsigned short)0
  #define PR_ISHIFT_RUN_MIN       65,22+_pPAR ,_BNK01,_8BIT ,_RW, _NVL, (unsigned short)0
  #define PR_IMAIN_KEEP_MIN       66,23+_pPAR ,_BNK01,_8BIT ,_RW, _NVL, (unsigned short)0
  #define PR_ISHIFT_KEEP_MIN      67,24+_pPAR ,_BNK01,_8BIT ,_RW, _NVL, (unsigned short)0
  ...
  #define PR_AR_TMO               70,11+_pPAR ,_BNK01,_8BIT ,_RW, _NVL, (unsigned short)0

  #define PCB190_NREGISTERS       71
  ...
  volatile _DeviceRegItem_Str  PCB190_Registers[]=
  {
    ...
    _REGDEF(RG190_TOMO_SAMPLES),
    _REGDEF(RG190_TOMO_PREWIN),      
    ...
    _REGDEF(PR190_NSAMPLES_TIME),
    _REGDEF(PR190_SAMPLES_TIME),
