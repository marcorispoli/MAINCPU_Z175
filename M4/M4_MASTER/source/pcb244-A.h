...
#undef extrd
  ...
  #define RG244_A_RXCMD              4,_pSYS+6   ,_BNK01,_8BIT ,_RW, _VL, (unsigned short)0
  #define RG244_A_PULSES             5,_pSYS+7   ,_BNK01,_16BIT ,_RW, _VL, (unsigned short)0
  #define RG244_A_PULSES_EXIT        6,_pSYS+9   ,_BNK01,_16BIT ,_RD, _VL, (unsigned short)0
  #define RG244_A_RAD1               7,_pSYS+11  ,_BNK01,_16BIT ,_RD, _VL, (unsigned short)0
  #define RG244_A_RAD5               8,_pSYS+13  ,_BNK01,_16BIT ,_RD, _VL, (unsigned short)0
  #define RG244_A_RAD25              9,_pSYS+15  ,_BNK01,_16BIT ,_RD, _VL, (unsigned short)0
  #define RG244_A_OFFSET             10,_pSYS+17  ,_BNK01,_16BIT ,_RW, _VL, (unsigned short)0

  #define PCB244_A_NREGISTERS    11
  ...
  #define COMMAND_SMP_RAD     4
  #define COMMAND_CALIB_TUBE_EXPOSE     5
  ...
  ext bool pcb244_A_StartManual(void);
