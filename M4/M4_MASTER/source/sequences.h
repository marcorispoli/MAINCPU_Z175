...
#undef extrd
 ...
 ext void std_rx_task(uint32_t initial_data);
 ext void std_ae_rx_task(uint32_t initial_data);
 ext void std_aec_rx_task(uint32_t taskRegisters);
...
// SEQUENZA TOMO AEC 
extern _RxStdSeq_Str tomoAecParam;
extern bool tomoAecSeqResult;
extern unsigned char tomoAecError;
extern bool tomoAecIsRunning;
...
// SEQUENZA RAGGI AEC
extern _RxStdSeq_Str rxStdAecParam;
extern bool rxStdAecSeqResult;
extern bool rxStdAecIsRunning;
extern unsigned char rxStdAecError;

// SEQUENZA RAGGI AE
extern _RxStdSeq_Str rxAeParam;
extern bool rxAeSeqResult;
extern bool rxAeIsRunning;
extern unsigned char rxAeError;
